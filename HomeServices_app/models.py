...
class Feedback(models.Model):
    ...
    image = models.ImageField(upload_to='feedback_images/', null=True, blank=True)  # <-- Add this

    def __str__(self):
        return f"{self.user.username} rated {self.employee.admin.username} - {self.rating}"
